    ...
    <div className="container-fluid">
        ...
        <div className="searchSection">
          <button className="orangeBtn" onClick={handleShowModal}>
            <i className="bi bi-file-earmark-play"></i> Add Counsellor List
          </button>
          {showModal && (
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title"> Add Counsellor List</h5>
                    <button
                      type="button"
                      className="btn-close"
          ...
          <table className="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <button className="btn btn-warning btn-sm mx-1 text-white"><i class="bi bi-eye"></i> View Centers</button>
                <button className="btn btn-warning btn-sm mx-1 text-white"><i class="bi bi-eye"></i> View Students</button>
